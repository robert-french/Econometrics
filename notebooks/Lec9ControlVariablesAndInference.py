    ...
    mo.sidebar(
        [
            ...
            mo.md(
                ...
                9. **[Control Variables and Inference](#top)**
                    1. [The least squares assumptions with multiple independent variables](#sec1)
                    1. [Control variables](#sec2)
                    1. [Bad controls](#sec3)
                    1. [The variance of a coefficient with multiple independent variables](#sec4)
                    1. [Hypothesis testing a single coefficient](#sec5)
...
def _(mo):
    mo.hstack(
        [
            ...
            mo.md('<a href="https://robert-french.github.io/Econometrics/pdf/Lec9ControlVariablesAndInference.pdf" target="_blank">Download PDF</a>'),
